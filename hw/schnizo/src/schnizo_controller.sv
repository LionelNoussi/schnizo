...
module schnizo_controller import schnizo_pkg::*; #(
  ...
  assign load_addr_misaligned_o  = lsu_addr_misaligned_i && ((instr_decoded_i.fu == LOAD) || (instr_decoded_i.fu == ALU_LSU_LOAD)) &&
                                   instr_valid_i && operands_ready;
  assign store_addr_misaligned_o = lsu_addr_misaligned_i && ((instr_decoded_i.fu == STORE) || (instr_decoded_i.fu == ALU_LSU_STORE)) &&
                                   instr_valid_i && operands_ready;
