...
module schnizo_writeback import schnizo_pkg::*; #(
  ...
  // ALU_LSU Port 0
  assign alu_lsu_gpr_valids[0]      = !alu_lsu_result_tags_i[0].dest_reg_is_fp ? alu_lsu_results_valid_i[0] : 1'b0;
  ...
  always_comb begin : int_regfile_writeback
    ...
    if (!gpr_port_used && alu_lsu_gpr_valids[0]) begin
      if (alu_lsu_result_tags_i[0].dest_reg != '0) begin
        ...
        gpr_wdata_o           = alu_lsu_result_tags_i[0].is_jump ? consecutive_pc_i : alu_lsu_results_i[0];
